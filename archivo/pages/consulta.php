...
<form 
action                     ="/overprime/compras/carga-de-datos/registrar/grabar-requerimiento.php"
...
$sql="SELECT (ROW_NUMBER() OVER(ORDER BY D.CODIGODATOS_RQ))AS ITEM,
...
$txtx                      =$txtx.=$i;
?>
<td><b><?php echo utf8_encode($row[ITEM]); ?></b>  </td>
